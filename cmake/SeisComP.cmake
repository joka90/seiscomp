MACRO(SC_BEGIN_PACKAGE ...)
	...
	IF (${ARGC} GREATER 1)
		...
		SET(SC3_PACKAGE_SHARE_DIR ${ARGV1}/share/seiscomp)
		SET(SC3_PACKAGE_INIT_DIR ${ARGV1}/etc/seiscomp/init)
		SET(SC3_PACKAGE_CONFIG_DIR ${ARGV1}/etc/seiscomp/defaults)
		SET(SC3_PACKAGE_APP_CONFIG_DIR ${ARGV1}/etc/seiscomp)
		SET(SC3_PACKAGE_APP_DESC_DIR ${ARGV1}/etc/seiscomp/descriptions)
		SET(SC3_PACKAGE_TEMPLATES_DIR ${ARGV1}/share/seiscomp/templates)
	ELSE (${ARGC} GREATER 1)
		SET(SC3_PACKAGE_DIR ".")
		...
		SET(SC3_PACKAGE_SHARE_DIR share/seiscomp)
		SET(SC3_PACKAGE_INIT_DIR etc/seiscomp/init)
		SET(SC3_PACKAGE_CONFIG_DIR etc/seiscomp/defaults)
		SET(SC3_PACKAGE_APP_CONFIG_DIR etc/seiscomp)
		SET(SC3_PACKAGE_APP_DESC_DIR etc/seiscomp/descriptions)
		SET(SC3_PACKAGE_TEMPLATES_DIR share/seiscomp/templates)
